/******* LCD-Library for PBA  ***************************************************************
 *																							*
 * Titel: 			PBA5 Board-Support-Library, LCD-hardware-drivers for dog-m LCD-Series	*
 ...
 * Version:			6.0.4																  	*
 * History:			R.Seiler	30.01.2000: Release 1 for PICBoard Basic (HD44780-LCD		*
 *					R.Seiler	11.02.2004: Release 2 for PBA3 and CCS-C-Compiler			*
 *					R.Seiler	23.12.2006:	Release 3 for PBA4 and CCS-C-Compiler			*
 *											ported for dog-m series LCDs					*
 *					R.Seiler	05.09.2007: Minor bugfixes, cleanup and optimizing			*
 *					R.Seiler	07.11.2008:	Release 4 ported to BoostC-Compiler				*
 *					R.Seiler	03.04.2009:	Release 5 ported to HI-TECH C-Compiler			*
 *					R.Seiler	06.04.2009:	Cleanup											*
 *					R.Seiler	22.11.2010: Module structure optimized and code documented	*
 *					R.Seiler	23.11.2010: Simplified lcd_send and dependent functions		*
 *											add makros lcd_send_data and lcd_send_command	*
 *					R.Seiler	18:05.2011: Changes for new library structures				*
 *																							*
 * Info:			Library for text-LCD of dog-m series. In order to use with standard 	*
 *					HD44780 or compatible LCDs (4-Bit mode) -> change the lcd_init()-		*
 *					function. In order to change the data-interface for 8-Bit- or SPI/I2C-	*
 *					modes change the lcd_send()-function.									*
 *																							*
 *					Using with alternative pin-assignement -> change the according defines	*
 *					(LCD_D4, LCD_D5, LCD_D6, LCD_D7, LCD_RW, LCD_EN and LCD_RS)				*
 *																							*
 ********************************************************************************************/
#include "lcd.h"
#include "../config/board_config.h"
	...
	void lcd_init(void)
	{
		__delay_ms(20);						//Betriebsspannung am LCD f�r mind. 40ms vorhanden
                __delay_ms(20);
		...
		LCD_RW=0;							//Auf LCD schreiben...
	  	...
	  	__delay_ms(2);						//Pause gem�ss init-Ablauf (siehe Datenblatt)
